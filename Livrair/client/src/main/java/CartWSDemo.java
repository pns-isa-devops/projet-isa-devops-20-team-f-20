...
public class CartWSDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		DeliveryWebService ws = initialize(host, port);
		System.out.println("#### Running the demo");
		demo(ws);
	}

	private static void demo(DeliveryWebService ws) throws Exception {
		List<Packages> packages = ws.getCustomerCartContents("john");
