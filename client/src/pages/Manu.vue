    ...
    <v-container fluid>
        ...
        <v-row align="strat" justify="space-around">
            <v-col cols="3" align-self="center">
                <v-alert data-cy="manu_package_success_alert" dismissible dense text type="success"
                         v-model="this.displaySuccessPackage">
                    Package status <strong>succesfully</strong> changed !
                </v-alert>

                <v-alert data-cy="manu_package_failed_alert" dismissible dense outlined type="error"
                         v-model="this.displayFailedPackage">
              ...
              <span>PACKAGE STATUS</span>
                        ...
                        <v-form ref="formPackage" v-model="validPackage" lazy-validation>
                            <v-row align="center" justify="space-around">
                                <v-col cols="4">
                                    <v-text-field data-cy="manu_package_id" name="packageID" v-model="packageId"
                                                  label="Package ID"
                            ...
                            <v-row align="center" justify="space-around">
                                <v-btn tile data-cy="manu_package_status_button" :disabled="!validPackage"
            ...
            <v-col cols="3" align-self="start">
                <v-alert data-cy="manu_delivery_success_alert" dismissible dense text type="success"
                         v-model="this.displaySuccessDelivery">
                    Delivery <strong>succesfully</strong> launched !
                </v-alert>

                <v-alert data-cy="manu_delivery_failed_alert" dismissible dense outlined type="error"
                         v-model="this.displayFailedDelivery">
            ...
            <span class="title text-upper" color="" dark>
              ...
              <span>DELIVERY</span>
                        ...
                        <v-form ref="formDelivery" v-model="validDelivery" lazy-validation>
                            <v-row align="center" justify="center">
                                <v-col cols="4">
                                    <v-text-field data-cy="manu_launch_delivery_delivery_id" name="DeliveryID"
                                                  v-model="deliveryId"
                                                  label="Delivery ID" id="idDelivery" :rules="idRules"
                                                  required></v-text-field>
                                </v-col>
                            </v-row>
                            <v-row align="center" justify="space-around">
                                <v-btn tile data-cy="manu_launch_delivery_button" :disabled="!validDelivery"
                                       color="blue white--text"
                ...
                this.xmlhttp.onreadystatechange = function () {
                    if (context.xmlhttp.readyState == 4) {
                        if (context.xmlhttp.status == 200) {
                            ...
                            let createdDelivery = respXML.getElementsByTagName('started')[0].innerHTML
