              ...
              <span>DRONE STATUS</span>
                        ...
                        <v-form ref="form" v-model="validPackage" lazy-validation>
                            <v-row align="center" justify="space-around" wrap>
                                <v-col cols="3">
                                    <v-text-field data-cy="garage_drone_id" name="droneID" v-model="droneId"
                                                  label="Drone ID" id="idDrone" :rules="idRules"
                                                  required></v-text-field>
                                </v-col>
                                <v-col cols="3">
                                    <v-select data-cy="garage_drone_status" :items="items" v-model="droneStatus"
                                              label="Drone Status" :rules="statusRules">
                                    </v-select>
                                </v-col>
                                <v-col cols="3">
                                    <v-btn tile data-cy="garage_drone_status_button" :disabled="!validDrone"
                                           color="yellow darken-1" @click="validate">
                                        Change drone status
                                    </v-btn>
                                </v-col>
                            </v-row>
